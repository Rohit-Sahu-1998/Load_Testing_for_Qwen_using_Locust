...
async def process_job(job_id: str):
    ...
    try:
        ...
        job["metrics"]["page_timings"] = result.get("page_timings", {})
        job["metrics"]["page_concurrency_limit"] = result.get("page_concurrency_limit")
        ...
        print("Page Timings:")
        print(json.dumps(result.get("page_timings", {}), indent=2))
        print("GPU Before:")
...
async def submit_file(file: UploadFile = File(...)):
    ...
    return SubmitResponse(
        ...
        message=(
            ...
            "Inference will be scheduled by vLLM internal queue."
        ),
    )
